...
export const en = {
  ...
  progress: {
    ...
    fluencyTrendLabel: 'vs previous 30 days',
    fluencySlower: '{{change}} slower',
    fluencyFaster: '{{change}} faster',
    fluencyUnchanged: 'unchanged',
    fluencyFindingsTitle: 'What noticeably slows you down',
    fluencyMilliseconds: '{{value}} ms',
    fluencySeconds: '{{value}} s',
    fluencySlowLetters: 'Slower with these letters',
    fluencyPracticeMode: '{{mode}} mode',
    familiarity: {
    ...
    wordLength: {
      short: '1–3 letters',
      medium: '4–5 letters',
      long: '6 or more letters',
    },
    promptMode: {
      standard: 'Standard',
      'flash-revealed': 'Flash, revealed',
      'flash-unrevealed': 'Flash, unrevealed',
    },
